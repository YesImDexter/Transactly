...
export function renderDashboard() {
  return `
    <div class="w-full max-w-6xl mx-auto bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl overflow-hidden my-8 md:flex transition-all duration-300 hover:shadow-xl">
